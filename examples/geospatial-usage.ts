...
export function MapViewportExample() {
  ...
  return (
    <div>
      ...
      <p>Found {reportsInViewport?.length || 0} reports</p>
      {/* You would render these on a map */}
    </div>
  )
}
...
export function DistanceCalculationExample() {
  ...
  return (
    <div>
      <h3>Distance from Central Station to Airport:</h3>
      {calculateDistance && (
        <p>
...
export function AdvancedFilteringExample() {
  ...
  return (
    <div>
      <h3>Crowding reports near you:</h3>
